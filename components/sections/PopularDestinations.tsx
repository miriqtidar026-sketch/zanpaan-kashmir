      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-gray-600">
            Discover Srinagar, Gulmarg, Pahalgam, and Sonamarg—four of the most
            beautiful destinations in Kashmir for unforgettable holidays,
            honeymoon trips, family vacations, and adventure tours.
          </p>
        </div>
            ...
            <article key={place.slug}>
              ...
              >
                <div className="relative h-[420px]">
                  <Image
                    src={place.image}
                    alt={`${place.name}, Kashmir - Tourist destination by Zanpaan Kashmir`}
                    fill
