...
export default function PackageCard({
  ...
  return (
    <article className="group overflow-hidden rounded-[32px] bg-white shadow-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
      {/* Image */}
      <div className="relative h-[420px] overflow-hidden">
        <Image
          src={image}
          alt={`${title} - Premium Kashmir tour package by Zanpaan Kashmir`}
          fill
